...
7. **Lesson teaching format (content lessons):**
   ...
   - **Vocabulário da Aula:** Apresentar todo o pool de palavras da Aula X (seção `## Aula X` de `Content/N5_Vocabulary.md`) agrupado por **tema semântico/didático**, com traduções e collocations.
