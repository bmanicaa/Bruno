...
10. **Session commands:** 
    ...
    - `"Reading Aula N"` / `"Leitura Aula N"` → gera o treino de leitura narrativa em Markdown em `Practice/N5_PN_Reading.md` seguindo `Filters/Exercises.md` e `Filters/Modalidades/Reading.md`.
    - `"Corrigir Aula N"` / `"Avalie o Practice/N5_PN.md"` → lê o arquivo de exercícios `Practice/N5_PN.md` (ou `Practice/N5_PN_Reading.md`), corrige as respostas digitadas pelo estudante, atribui nota e dá feedback detalhado no chat.
