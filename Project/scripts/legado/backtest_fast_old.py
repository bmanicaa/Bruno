...
def run_single_asset_backtest_5pct(symbol, btc_4h, btc_1d, fng_df, risk_pct=0.05, fee_pct=0.00075):
    df_4h = compute_indicators_4h(fetch_klines_extended(symbol, interval='4h', total_candles=2500))
    df_1d = compute_indicators_1d(fetch_klines_extended(symbol, interval='1d', total_candles=500))
...
def main():
    ...
    btc_4h = compute_indicators_4h(fetch_klines_extended('BTCUSDT', interval='4h', total_candles=2500))
    btc_1d = compute_indicators_1d(fetch_klines_extended('BTCUSDT', interval='1d', total_candles=500))
